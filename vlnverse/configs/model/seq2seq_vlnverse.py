...
seq2seq_cfg = ModelCfg(
    ...
    instruction_encoder=InstructionEncoder(
        ...
        embedding_file='data/vlnverse/raw_data/vlnverse/final_splits_with_distance_formal/embeddings.json.gz',
        dataset_vocab='data/vlnverse/raw_data/r2r/train/train.json.gz',
...
seq2seq_eval_cfg = ModelCfg(
    ...
    instruction_encoder=InstructionEncoder(
        ...
        vocab_size=2504,
        use_pretrained_embeddings=True,
        embedding_file='data/vlnverse/raw_data/r2r/embeddings.json.gz',
        dataset_vocab='data/vlnverse/raw_data/r2r/train/train.json.gz',
        fine_tune_embeddings=False,
        embedding_size=50,
        hidden_size=128,
