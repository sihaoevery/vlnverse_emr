...
@click.command()
@click.option('--reference', '-r', required=True, help="Reference video whose last frame will define goal.")
@click.option('--input', '-i', required=True, help='Dataset path to evaluate.')
@click.option('--camera_idx', '-ci', default=0, type=int, help="Camera index to compute metrics")
