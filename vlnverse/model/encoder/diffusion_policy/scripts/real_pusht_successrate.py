...
@click.command()
@click.option('--reference', '-r', required=True, help='Reference metrics_raw.json from demonstration dataset.')
@click.option('--input', '-i', required=True, help='Data search path')
