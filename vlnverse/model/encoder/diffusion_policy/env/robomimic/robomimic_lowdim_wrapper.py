...
class RobomimicLowdimWrapper(gym.Env):
    def __init__(
        ...
        self.observation_space = Box(low=low, high=high, shape=low.shape, dtype=low.dtype)
...
def test():
    ...
    wrapper = RobomimicLowdimWrapper(
        env=env, obs_keys=['object', 'robot0_eef_pos', 'robot0_eef_quat', 'robot0_gripper_qpos']
    )
