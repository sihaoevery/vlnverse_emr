...
rdp_vlnverse_exp_cfg = ExpCfg(
    ...
    il=IlCfg(
        ...
        # ckpt_to_load='checkpoints/20251109_rdp_vlnverse_c1/ckpts/checkpoint-17163',
        # dataset_r2r_root_dir='data/vlnverse/raw_data/vlnverse',
        ckpt_to_load='',
        ...
        # lerobot_features_dir='data/vlnverse/traj_data/kujiale',
