...
eval_cfg = EvalCfg(
    agent=AgentCfg(
        ...
        model_settings={
            ...
            'vis_debug_path': './logs/20251111_rdp_flash_vlnverseFine_ckptC2_82001/vis_debug',
        },
    ),
    env=EnvCfg(
        env_type='vln_pe',
    ...
    task=TaskCfg(
        task_name='20251113_rdp_flash_vlnverseRealFine_ckptC2_82001_test',
        task_settings={
            'env_num': 1,
